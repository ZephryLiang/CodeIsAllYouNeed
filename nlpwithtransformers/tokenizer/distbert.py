...
distilbert_tokenizer = DistilBertTokenizer.from_pretrained(model_ckpt,tokenize_chinese_chars=True,pad_token='[pad]',unk_token="[UNKNOWN]")
try:
...
print(f"distilbert_tokenizer :{str(encoded_text)}")
